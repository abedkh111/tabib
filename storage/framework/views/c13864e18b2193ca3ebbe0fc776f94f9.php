...
<body class="bg-gray-50">
    <nav class="bg-blue-600 text-white shadow-lg">
        <div class="max-w-7xl mx-auto px-4">
            <div class="flex justify-between items-center py-4">
                ...
                <div>
                    <a href="<?php echo e(route('admin.research-and-news.index')); ?>" class="bg-blue-700 hover:bg-blue-800 px-3 py-2 rounded">العودة</a>
                </div>
            </div>
        </div>
    </nav>
    ...
    <div class="max-w-4xl mx-auto py-8 px-4">
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            <form method="POST" action="<?php echo e(route('admin.research-and-news.store')); ?>" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <div class="space-y-6">
                    <div>
                        ...
                        <select id="type" name="type" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500">
                            <option value="medical_research" <?php echo e(old('type') == 'medical_research' ? 'selected' : ''); ?>>أبحاث طبية</option>
                            <option value="scientific_news" <?php echo e(old('type') == 'scientific_news' ? 'selected' : ''); ?>>أخبار علمية</option>
                            <option value="medical_news" <?php echo e(old('type') == 'medical_news' ? 'selected' : ''); ?>>أخبار طبية</option>
                        </select>
                    </div>
                    <div>
                        <label for="title_ar" class="block text-sm font-medium text-gray-700 mb-2">العنوان (عربي) *</label>
                        <input type="text" id="title_ar" name="title_ar" value="<?php echo e(old('title_ar')); ?>" required
                    ...
                    <div>
                        ...
                        <textarea id="summary_ar" name="summary_ar" rows="3"
                                  class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500"><?php echo e(old('summary_ar')); ?></textarea>
                    </div>
                    <div>
                        ...
                        <textarea id="content_ar" name="content_ar" rows="10" required
                                  class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500"><?php echo e(old('content_ar')); ?></textarea>
                    </div>
                    <div>
                        ...
                        <textarea id="content_en" name="content_en" rows="10"
                                  class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500"><?php echo e(old('content_en')); ?></textarea>
                    </div>
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            <label for="author" class="block text-sm font-medium text-gray-700 mb-2">المؤلف</label>
                            <input type="text" id="author" name="author" value="<?php echo e(old('author')); ?>"
                                   class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500">
                        </div>
                        <div>
                    ...
                    <div>
                        ...
                        <input type="date" id="published_date" name="published_date" value="<?php echo e(old('published_date')); ?>"
                               class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500">
                    </div>
                    <div>
                        <label for="tags" class="block text-sm font-medium text-gray-700 mb-2">الوسوم (مفصولة بفواصل)</label>
                        <input type="text" id="tags" name="tags" value="<?php echo e(old('tags')); ?>"
                    ...
                    <div class="flex justify-end space-x-4 space-x-reverse">
                        <a href="<?php echo e(route('admin.research-and-news.index')); ?>" class="px-6 py-2 bg-gray-300 text-gray-700 rounded-lg">إلغاء</a>
...
<?php /**PATH /home/abedkh/Documents/tabib/resources/views/admin/research-and-news/create.blade.php ENDPATH**/ ?>
...
<body class="bg-gray-50 font-cairo">
    ...
    <div class="max-w-7xl mx-auto py-8 px-4">
            ...
            <div class="flex items-center mb-4">
                ...
                <div>
                    <h2 class="text-2xl font-bold text-gray-800">
                        مرحباً بك في لوحة الإدارة، <?php echo e(auth()->user()->name); ?>!
                    </h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
            <a href="<?php echo e(route('admin.users.index')); ?>" class="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow group">
            ...
            <a href="<?php echo e(route('admin.courses.index')); ?>" class="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow group">
                <div class="flex items-center">
            ...
            <a href="<?php echo e(route('admin.questions.index')); ?>" class="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow group">
                <div class="flex items-center">
            ...
            <a href="<?php echo e(route('admin.analytics')); ?>" class="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow group">
                <div class="flex items-center">
            ...
            <a href="<?php echo e(route('admin.settings')); ?>" class="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow group">
                <div class="flex items-center">
            ...
            <a href="<?php echo e(route('admin.research-and-news.index')); ?>" class="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow group">
                <div class="flex items-center">
                    <div class="p-3 rounded-full bg-blue-100 text-blue-600 ml-4 group-hover:scale-110 transition-transform">
            ...
            <a href="<?php echo e(route('admin.section-titles.index')); ?>" class="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow group">
                <div class="flex items-center">
                    <div class="p-3 rounded-full bg-blue-100 text-blue-600 ml-4 group-hover:scale-110 transition-transform">
            ...
            <a href="<?php echo e(route('dashboard')); ?>" class="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow group">
                <div class="flex items-center">
...
<?php /**PATH /home/abedkh/Documents/tabib/resources/views/admin/dashboard.blade.php ENDPATH**/ ?>
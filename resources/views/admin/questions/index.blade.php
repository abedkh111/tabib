    ...
    <nav class="bg-red-600 text-white shadow-lg">
        <div class="max-w-7xl mx-auto px-4">
            <div class="flex justify-between items-center py-4">
                ...
                <div class="flex items-center space-x-4 space-x-reverse">
                    <a href="{{ route('admin.questions.create') }}" class="bg-blue-600 hover:bg-blue-700 px-3 py-2 rounded">
        ...
        <div class="bg-white rounded-lg shadow-md p-6 mb-8">
            <div class="flex items-center justify-between">
                ...
                <div class="text-sm text-gray-600">
                    <span class="font-semibold">إجمالي الأسئلة:</span> {{ $questions->total() }}
                </div>
            </div>
        </div>

        <!-- Bulk Actions and Questions Table -->
        <form method="POST" action="{{ route('admin.questions.bulk-approve') }}" id="bulkForm">
            @csrf
            <!-- Bulk Actions Bar -->
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-900">{{ $question->user->name ?? 'غير محدد' }}</div>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <div class="flex items-center space-x-2 space-x-reverse">
                                    ...
                                    @if(!$question->is_approved)
                                        <form method="POST" action="{{ route('admin.questions.approve', $question) }}" class="inline approve-form">
                                            @csrf
                                            <button type="submit" 
                                    ...
                                    @else
                                        <form method="POST" action="{{ route('admin.questions.reject', $question) }}" class="inline reject-form">
                                            @csrf
                                            <button type="submit" 
            ...
            <div class="bg-gray-50 px-4 py-3 border-t border-gray-200 sm:px-6">
                <div class="flex items-center justify-between">
                    <div class="flex-1 flex justify-between sm:hidden">
                        ...
                        @else
                            <a href="{{ $questions->previousPageUrl() }}" class="relative inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50">
                                السابق
                            </a>
                        @endif

                        @if($questions->hasMorePages())
                            <a href="{{ $questions->nextPageUrl() }}" class="mr-3 relative inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50">
                                التالي
                            </a>
                        @else

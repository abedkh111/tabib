    ...
    <nav class="bg-blue-600 text-white shadow-lg">
        <div class="max-w-7xl mx-auto px-4">
            <div class="flex justify-between items-center py-4">
                ...
                <div>
                    <a href="{{ route('admin.questions.index') }}" class="bg-blue-700 hover:bg-blue-800 px-3 py-2 rounded">العودة</a>
                </div>
            </div>
        </div>
    </nav>
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <textarea id="question_text" name="question_text" rows="4" required
                                  class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500">{{ old('question_text', $question->question_text) }}</textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea id="explanation" name="explanation" rows="3"
                                  class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500">{{ old('explanation', $question->explanation) }}</textarea>
                    </div>

                    <div>
                        <div class="flex justify-between items-center mb-4">
                            <label class="block text-sm font-medium text-gray-700">خيارات الإجابة (يجب تحديد خيار صحيح واحد على الأقل)</label>
                            <button type="button" onclick="addOption()" class="text-sm text-blue-600 hover:text-blue-800">
                    ...
                    <div class="flex items-center space-x-4 space-x-reverse">
                        <label class="flex items-center">
                            <input type="checkbox" name="is_approved" value="1" {{ old('is_approved', $question->is_approved) ? 'checked' : '' }}
                                   class="ml-2 w-5 h-5 text-blue-600 border-gray-300 rounded">
                            <span class="text-sm text-gray-700">معتمد</span>
                        </label>
                        <label class="flex items-center">
                    ...
                    <div class="flex justify-end space-x-4 space-x-reverse">
                        <a href="{{ route('admin.questions.index') }}" class="px-6 py-2 bg-gray-300 text-gray-700 rounded-lg">إلغاء</a>

...
<head>
    ...
    <title>إضافة عنوان قسم - منصة طبيب التعليمية</title>
...
<body class="bg-gray-50">
        ...
        <div class="max-w-7xl mx-auto px-4">
            <div class="flex justify-between items-center py-4">
                <div class="flex items-center space-x-4 space-x-reverse">
                    ...
                    <h1 class="text-xl font-bold">إضافة عنوان قسم</h1>
                </div>
                <div>
    ...
    <div class="max-w-3xl mx-auto py-8 px-4">
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            <form method="POST" action="{{ route('admin.section-titles.store') }}">
                @csrf
                <div class="space-y-6">
                    <div>
                        ...
                        <input type="text" id="key" name="key" value="{{ old('key') }}" required
                               placeholder="مثال: courses_section"
                    ...
                    <div>
                        ...
                        <textarea id="description_ar" name="description_ar" rows="3"
                                  class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500">{{ old('description_ar') }}</textarea>
                    </div>
                    <div>
                        ...
                        <textarea id="description_en" name="description_en" rows="3"
                                  class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500">{{ old('description_en') }}</textarea>
                    </div>
                    <div>

...
<head>
    ...
    <title>تعديل الكورس - منصة طبيب التعليمية</title>
        ...
        <div class="max-w-7xl mx-auto px-4">
            <div class="flex justify-between items-center py-4">
                <div class="flex items-center space-x-4 space-x-reverse">
                    ...
                    <h1 class="text-xl font-bold">تعديل الكورس</h1>
                </div>
                <div>
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea id="description" name="description" rows="6" required
                                  class="w-full px-4 py-2 border border-gray-300 rounded-lg">{{ old('description', $course->description) }}</textarea>
                    </div>
                    <div>
